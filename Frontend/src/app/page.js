  ...
  return (
    <div className="p-10 ">
      <div>
        ...
        {profileImage ? <img src="https://cdn-icons-png.flaticon.com/128/15685/15685758.png"
            className="m-6 h-10 w-10 invert transition-transform duration-300 hover:scale-105"
          /> : 
          <img src="https://cdn-icons-png.flaticon.com/128/15685/15685758.png"
            className="m-6 h-10 w-10 invert transition-transform duration-300 hover:scale-105"
          />
        }
        ...
        <div className="absolute bottom-0 right-0 bg-neutral-800 m-6 w-100 h-100 rounded-2xl">
          <Tabs defaultValue="duel" className="top-0 right-0 w-[400px] dark:bg-gray-900 dark">
            <TabsList>
